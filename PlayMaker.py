...
PLAYERS_STARTING_POSITIONS = [
    # format: [x, y]
    [SECONDARY_HANDLER_STARTING_X, FIELD_HEIGHT-SCORING_ZONE_HEIGHT - STARTING_HANDLER_Y_OFFSET],
...
class PlayMaker:
    ...
    def draw_initial(self, screen):
        ...
        # Right stats panel
        pygame.draw.rect(screen, WHITE, (FIELD_WIDTH, 0, SCREEN_WIDTH-FIELD_WIDTH, SCREEN_HEIGHT))
